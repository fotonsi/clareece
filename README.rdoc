...
iClarice es una aplicación web, relizada en Ruby On Rails, que facilita la gestión interna de colegios profesionales, altas de colegiados y gestión de expedientes, formación continuada y registros de entrada y salida.
