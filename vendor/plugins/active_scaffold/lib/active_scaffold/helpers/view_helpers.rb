module ActiveScaffold
  module Helpers
    ...
    module ViewHelpers
      ...
      include ActiveScaffold::Helpers::FormLayoutHelpers
      ...
      def render_action_link(link, url_options)
        ...
        #FIXME add icon if it's defined
        label = image_tag(link.icon[:image], link.icon.reject{|k,v| k == :image}) unless link.icon.nil?
